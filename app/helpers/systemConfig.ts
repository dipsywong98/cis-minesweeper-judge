...
const config = {
  ...
  MINESWEEPER_UI_URL: env('MINESWEEPER_UI_URL', '/cis-minesweeper-ui/index.html'),
  MINESWEEPER_UI_DOWNLOAD_URL: env('MINESWEEPER_UI_DOWNLOAD_URL', '/cis-minesweeper-ui.zip'),
